import { sqrt, Token, CurrencyAmount, TradeType, WETH9, Ether, Percent, Price } from '@helix-bridge/sdk-core'
...
import { Pair, Route as V2RouteSDK } from '@helix-bridge/v2-sdk'
