import { BigintIsh, CurrencyAmount, Ether, Percent, Token, TradeType, WETH9 } from '@helix-bridge/sdk-core'
import { Pair, Route as V2Route, Trade as V2Trade } from '@helix-bridge/v2-sdk'
import {
  encodeSqrtRatioX96,
  FeeAmount,
  nearestUsableTick,
